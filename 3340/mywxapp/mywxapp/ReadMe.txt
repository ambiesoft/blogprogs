========================================================================
    Win32 アプリケーション: mywxapp プロジェクトの概要
========================================================================

この mywxapp アプリケーションは、AppWizard により作成されました。
...
mywxapp.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル mywxapp.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル mywxapp.rc 
    にインクルードされます。
